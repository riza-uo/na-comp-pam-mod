...
//	 	maps\mp\_utility::error("no defined weapon for the spawning player");
	...
	self maps\mp\gametypes\_pam_teams::givePistol();
	self maps\mp\gametypes\_pam_teams::giveGrenades(self.pers["weapon"]);
	self maps\mp\gametypes\_pam_teams::giveBinoculars(self.pers["weapon"]);
