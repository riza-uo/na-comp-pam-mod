...
{
	/* Match Setup Options */
	setcvar("scr_sd_half_round" , "12");	// Switch AFTER this round.

	setcvar("scr_sd_half_score" , "0");	// Switch AFTER this score.

	setcvar("scr_sd_end_round" , "24");	// End Map AFTER this round.
	...
	else if (getcvarint("g_ot_active") == 2)
	{
		...
		setcvar("g_ot", "0");	// No OT in 2nd Overtime
	}
	// *****************************************************
