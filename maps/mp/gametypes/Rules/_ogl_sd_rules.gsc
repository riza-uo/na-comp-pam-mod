...
{
	/* Match Setup Options */
	setcvar("scr_sd_half_round" , "0");	// Switch AFTER this round.

	setcvar("scr_sd_half_score" , "7");	// Switch AFTER this score.

	setcvar("scr_sd_end_round" , "0");	// End Map AFTER this round.

	setcvar("scr_sd_end_score" , "0");		// End Map AFTER this total score.

	setcvar("scr_sd_end_half2score" , "7");// End Map AFTER this 2nd-half score.
	...
	{
		setcvar("scr_sd_half_round" , "2");	// Switch AFTER this round.

		setcvar("scr_sd_half_score" , "0");	// Switch AFTER this score.

		setcvar("scr_sd_end_round" , "4");		// End Map AFTER this round.

		setcvar("scr_sd_end_score" , "3");		// End Map AFTER this total score.

		setcvar("scr_sd_end_half2score" , "0");// End Map AFTER this 2nd-half score.
	}
	if (getcvarint("g_ot_active") == 2)
	{
		setcvar("scr_sd_half_round" , "0");	// Switch AFTER this round.
		...
		setcvar("scr_sd_end_score" , "1");		// End Map AFTER this total score.
	...
	/* PAM cvars */
	// Draws & OT settings
	setcvar("scr_sd_count_draws", "1");	// Count rounds that end in a draw? 1=Yes 0=No
	...
	setcvar("sv_playersleft", "0");		// Turn OFF players left display
