Rules()
{
	...
	setcvar("scr_ctf_endrounddelay" , "20");
	setcvar("scr_ctf_clearscoreeachround" , "0");
	setcvar("scr_ctf_showoncompass" , "45");
	...
	setcvar("scr_ctf_count_draws", "1");	// Count rounds that end in a draw as a valid round number? 1=Yes 0=No (Almost Always YES in CTF)
	...
	{
		setcvar("scr_ctf_roundlength" , "7"); // Length of each round
