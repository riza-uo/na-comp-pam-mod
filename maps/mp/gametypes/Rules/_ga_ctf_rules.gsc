Rules()
{
	...
	setcvar("scr_ctf_endrounddelay" , "5");

	setcvar("scr_ctf_clearscoreeachround" , "0");

	// Respawn Timer
	setcvar("scr_death_wait_time", "20");
	...
	setcvar("scr_usetouches", "1");	//If the map score is tied, uses the number of times a team was able to touch the opponents flag to determine a winner
