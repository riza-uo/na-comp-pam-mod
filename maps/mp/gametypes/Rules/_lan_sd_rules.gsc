...
{
	/* Match Setup Options */
	setcvar("scr_sd_half_round" , "1");	// Switch AFTER this round.

	setcvar("scr_sd_half_score" , "0");	// Switch AFTER this score.

	setcvar("scr_sd_end_round" , "2");	// End Map AFTER this round.
	...
	else if (getcvarint("g_ot_active") == 2)
	{
		setcvar("scr_sd_half_round" , "0");	// Switch AFTER this round.

		setcvar("scr_sd_end_round" , "1");		// End Map AFTER this round.
	...
	// Hostname and MOTD 
	setcvar("sv_hostname" , "Unknown LAN - Rename Me"); 
	setcvar("scr_motd" , "Unknown LAN - Rename Me"); 

	//Logo
	game["leaguestring"] = &"Unknown LAN Match Mode"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
