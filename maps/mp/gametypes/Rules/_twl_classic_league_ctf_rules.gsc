Rules()
{
	...
	setcvar("scr_ctf_endrounddelay" , "15");
	...
	// Hostname and MOTD 
	setcvar("sv_hostname" , "^1TWL ^7CTF ^3Classic League Match"); 
	setcvar("scr_motd" , "PAMUO v3.1 TWL-Classic League Match Mode v1.2"); 

	//Logo
	game["leaguestring"] = &"TWL-Classic League Match Mode v1.2";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
	...
	if (getcvarint("g_ot_active") == 1)
	{
		...
		setcvar("scr_ctf_roundlength" , "20"); // Length of each round
