Rules()
{
	...
	setcvar("scr_tdm_half_time" , "1");	// Switch AFTER this amount of time. 0 = Don't switch and scr_tdm_timelimit is used.
	...
	// Hostname and MOTD 
	setcvar("sv_hostname" , "Unknown LAN Match in Progress"); 
	setcvar("scr_motd" , "Unknown LAN Match - Rename Me!"); 

	// Logo
	game["leaguestring"] = &"LAN Unknown Match Mode"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
