...
main()
{
	...
	// PAM UO Enable/Disable Feature
	if (getcvar("svr_pamenable") == "")
		setcvar("svr_pamenable", "0");
	
	if (getcvarint("svr_pamenable") > 0)
	{
		// PAM UO is enabled, run modified tank limiter script
		maps\mp\_pam_jeepdrive_gmi::modifiedjeepmain();
		return;
	}
